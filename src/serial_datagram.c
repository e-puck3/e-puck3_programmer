/*
* https://github.com/cvra/serial-datagram
* 
* Modified by Eliot Ferragni to include the crc32 function, otherwise there could be conflicts with others crc32.c files.
*/
